                ...
                <div className={styles.aftervw}>
                    ...
                    <div className={styles.portfoliocontainer}>
                        ...
                        <div className={styles.floattxt}>
                            <motion.div style={{zIndex:2}} onClick={() => { index === 0 ? setIndex(2) : setIndex(index - 1); }} className={styles.firstimg}>
                                <Framer>
                            ...
                            <motion.div style={{zIndex:2}} onClick={() => { index === 2 ? setIndex(0) : setIndex(index + 1); }} className={styles.secimg}>
                                <Framer>
                                    <svg width="70" height="50" viewBox="0 0 156 131" fill="none" xmlns="http://www.w3.org/2000/svg">
